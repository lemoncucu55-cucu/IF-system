# ╔══════════════════════════════════════════════════════════════╗
# ║ IF Crystal 全雲端系統 v10 ─ History 強化版                   ║
# ║ 2026.03.27 已加強補貨與新建商品的 History 記錄               ║
# ╚══════════════════════════════════════════════════════════════╝
...
st.caption("請先測試「補貨」功能，然後切換到「紀錄查詢」查看是否出現新紀錄")
